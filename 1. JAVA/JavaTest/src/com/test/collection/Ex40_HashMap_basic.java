...
//		m1();
	...
	private static void m2() {
		...
		System.out.println(map.get("과학")); //없는 키 요청시 null
		
		//4. 요소 수정하기
		int result = map.put("국어", 98); //동일한 키값 사용시 덮어쓰기
		System.out.println(map.get("국어")); //수정한 value
		System.out.println(result); //올드 value
