...
#bigimg, .img1, .img2, .img3, .img4, .img5, .img6
...
<body>
	<div id="main">
		...
		<div id="middle">
			<div id="topbanner"
				style="background-image: url(./images/${banner.img})"></div>
			...
			<div style="text-align: center;">
				...
				<div style="padding: 10px 0;">
					<div class="img img0" id="bigimg"
						style="width: 420px; height: 675px; display: inline-block; background-image: url(./images/${hot.get(0).img});"
						value="temp0">
			...
			<hr />
			<!-- 동영상 들어갈 자리 -->
			<div id="banner" style="background-image: url(./images/${banner2.img})"></div>
			<hr />
		...
		<div id="bottom">
			...
			<div class="txt">
				...
				<p class="black">Copyright &copy; At-Tickey Corp. All Rights
					Reserved.</p>
			</div>
			<div id="service">
				<p>
