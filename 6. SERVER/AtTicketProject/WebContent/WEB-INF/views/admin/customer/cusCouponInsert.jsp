...
<body>
    ...
    <div id="info" style="margin-left: 50px;">
        <legend style="width: 300px; margin:20px -1px; font-weight: bold;">쿠폰 추가</legend>
        ...
        <script>
            ...
            $("#modifybtn").click(function () {
                if(confirm("정말로 추가하시겠습니까?")){
                    location.href = "/AtTicketProject/customer/cuscouponinsertok.do?cusseq=${cusseq}&couponseq="+$('#couponseq').val();
                }
            });
        </script>
</body>
