...
<body>
    ...
    <!-- 여기에 내용 삽입 -->
    <div id = "title">
        <h1 id = "realTitle">공지사항 <small id = "mainHome"> > 공지  </small></h1>
    </div>
    ...
    <div class = "inputInfo" style = "height : 1000px;">
        <table  style = "height : 800px;">
            ...
            <tr style = "height : 70px;">
                <td class = title>&nbsp;&nbsp;파일이름</td>
                <td><input style="width:200px;display:inline;" type = "text" class = "form-control" value = "${dto.content}" disabled></td>
                
            </tr>       
            <tr  style = "height : 70px;">
            	<td class = "title">&nbsp;&nbsp;구분</td>
            	<td>
            		<input style="width:500px;" name = "nindex" type = "text" class = "form-control" value = "${dto.nindex}" disabled>
            	</td>
            </tr> 
             <tr  style = "height : 70px;">
            	<td class = "title">&nbsp;&nbsp;제목</td>
            	<td>
            		<input style="width:500px;" name = "title" type = "text" class = "form-control" value = "${dto.title}" disabled>
            	</td>
            </tr>  
             <tr  style = "height : 70px;">
            	<td class = "title">&nbsp;&nbsp;티켓오픈일시</td>
            	<td>
            		<input style="width:200px;" name = "opendate" type = "date" class = "form-control" value = "${dto.opendate}" disabled>
            	</td>
            </tr>   
            </table>
    </div> 
